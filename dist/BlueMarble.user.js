...
\uCE94\uBC84\uC2A4\uB97C \uBA3C\uC800 \uD074\uB9AD\uD574 \uBCF4\uC168\uB098\uC694?`);
  ...
  async function buildOverlayMain() {
    ...
    overlayMain.addDiv({ "id": "bm-overlay", "style": "top: 10px; right: 75px;" }).addDiv({ "id": "bm-contain-header" }).addDiv({ "id": "bm-bar-drag" }).buildElement().addImg(
      { "alt": "\uBE14\uB8E8 \uB9C8\uBE14 \uC544\uC774\uCF58 - \uB20C\uB7EC\uC11C \uCD5C\uC18C\uD654/\uCD5C\uB300\uD654", "src": "https://raw.githubusercontent.com/sungsoos/Wplace-LightBlueMarble-Userscripts/main/dist/assets/Favicon.png", "style": "cursor: pointer;" },
      (instance, img) => {
